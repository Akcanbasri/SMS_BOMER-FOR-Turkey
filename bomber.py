...
# Check if local 'sms.py' content matches the fetched content
...
while 1:
  ...
  SMS BOMBER +90
    ...
    Sms: {}                                      
    """.format(
            Fore.LIGHTRED_EX, len(servisler_sms), Style.RESET_ALL, Fore.CYAN
        )
    )
    print(
        Fore.LIGHTGREEN_EX
    ...
    if menu == 1:
        ...
        try:
            print(
                Fore.LIGHTYELLOW_EX
                + "Telefon numarasını başında '+90' olmadan yazınız (birden fazla ise enter basınız): "
                + Fore.LIGHTGREEN_EX,
                end="",
            )
            tel_no = input()
            ...
            if tel_no == "":
                ...
                try:
                    ...
                    system("cls||clear")
                    print(
                        Fore.LIGHTRED_EX + "Hatalı telefon numarası. Tekrar deneyiniz."
                    )
                    sleep(3)
                    continue
            else:
        ...
        try:
            print(
                Fore.LIGHTYELLOW_EX
                + "Mail adresi (Bilmiyorsan 'enter' bas): "
                + Fore.LIGHTGREEN_EX,
                end="",
            )
            mail = input()
